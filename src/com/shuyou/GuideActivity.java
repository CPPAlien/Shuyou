...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // 获取分辨率  
        ...
        View guide_one = inflater.inflate(R.layout.shuyou_guide_one, null);
        View guide_two = inflater.inflate(R.layout.shuyou_guide_two, null);
        View guide_three = inflater.inflate(R.layout.shuyou_guide_three, null);
        ...
        for (int i = 0; i < pageViews.size(); i++) {  
            ...
            if (i == 0) {  
                //默认选中第一张图片
                imageViews[i].setBackgroundResource(R.drawable.shuyou_guide_fill_circle);  
            } else {  
                imageViews[i].setBackgroundResource(R.drawable.shuyou_guide_blank_circle);  
            }  
    ...
    private class GuidePageChangeListener implements OnPageChangeListener {  
        ...
        public void onPageSelected(int arg0) {  
            ...
            for (int i = 0; i < imageViews.length; i++) {  
                imageViews[arg0].setBackgroundResource(R.drawable.shuyou_guide_fill_circle);

...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    private Vector<Map<String, String>> vecKeywords;  
    ...
    private void init() {  
        ...
        random = new Random();  
        vecKeywords = new Vector<Map<String, String>>(MAX);  
    ...
    public boolean feedKeyword(String keyword, String isbn) {  
        boolean result = false;  
        if (vecKeywords.size() < MAX) {
        	Map<String, String> map = new HashMap<String, String>();
        	map.put("name", keyword);
        	map.put("isbn", isbn);
            result = vecKeywords.add(map);  
        }  
        return result;  
    }  
    ...
    private boolean show() {  
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0 && enableShow) {  
            ...
            for (int i = 0; i < size; i++) {  
                final String keyword = vecKeywords.get(i).get("name");
                final String isbn = vecKeywords.get(i).get("isbn");
                vecKeywords.get(i).get("isbn");
                // 随机颜色  
                ...
                final Activity finalAct = mActivity;
                txt.setOnClickListener(new OnClickListener(){

					@Override
					public void onClick(View v) {
						// TODO Auto-generated method stub
						Intent i = new Intent(finalAct, BookInfoActivity.class);
						i.putExtra("type", "ViewBookDetail");
						i.putExtra("bookIsbn", isbn);
						i.putExtra("bookName", keyword);
						finalAct.startActivity(i);
					}
...
//                txt.setBackgroundColor(Color.RED);
    ...
    public Vector<Map<String, String>> getKeywords() {
        return vecKeywords;  
    }  
